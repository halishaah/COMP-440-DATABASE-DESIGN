...
<tr style="border:2px solid #FFF">
	<th>username</th><th>password</th><th>firstName</th><th>lastName</th><th>email</th><th>operation</th>
</tr>
...
function check(){
	var select = document.getElementById("select");//select type
	var select1 = document.getElementById("select1");//select column
	var textvalue = document.getElementById("select2").value;//select content
	...
	/*selectvalue =0fuzzy query  =1precise query  */
	if(selectvalue=="0"){
